...
@XmlType(name = "SettlementTimeRequest2", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08", propOrder = {
    "clsTm",
    "tillTm",
    "frTm",
    "rjctTm"
...
public class SettlementTimeRequest2 {
    ...
    @XmlElement(name = "CLSTm", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08")
